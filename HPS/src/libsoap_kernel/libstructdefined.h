...
typedef struct 
{
    ...
    //add for Interac Sequence number
    char szTransactionCode[_BASE_DATA_SIZE_];
    char szTransmissionNumber[_BASE_DATA_SIZE_];
    char szBankResponseCode[_BASE_DATA_SIZE_];
    char szMacKey[_BASE_DATA_SIZE_ * 4];
    char szPinKey[_BASE_DATA_SIZE_ * 4];
    char szFieldKey[_BASE_DATA_SIZE_ * 4];
    char szTraceNumber[_BASE_DATA_SIZE_];
    char szMessageAuthenticationCode[_BASE_DATA_SIZE_];
