...
public:
    ...
    static BOOL        Hex2Str(BYTE* pbyStrData, BYTE* pbyHexData, int nSize);

    static BOOL        Str2Hex(const char* pStr, BYTE* cOut);
    static void        Str2Hex(PCSTR pStr, CByteStream & cOut);
    static DWORD       Str2Hex(unsigned char *str, unsigned char *hex, unsigned int nLen);
