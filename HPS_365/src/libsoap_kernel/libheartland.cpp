...
unsigned short HeartlandSoap::HeartlandPackProcessEntry(SoapElementRef startNode, ST_HSOAP_REQUEST *hsoapData)
{
    ...
    if (txnType == tt_DEBIT_SALE || txnType == tt_DEBIT_RETURN)
    {
        HeartlandAddSubElement(startNode, NULL_STRING, NULL_STRING, TAG_NAME_EMV_CHIP_CONDITION, hsoapData->szEMVChipCondition, sizeof(hsoapData->szEMVChipCondition), false);
...
void HeartlandSoap::HeartlandUnpackTransaction(HeartLandResponse response, ST_HSOAP_RESPONSE *hsoapData)
{
    ...
    //add by Tinker, for Interac POS Sequence number 
    HeartlandParseResponse("DebitMac", "TransactionCode", NULL_STRING, NULL_STRING, NULL_STRING, PARSE_TYPE_TRANS, response, hsoapData->cTrans.szTransactionCode, sizeof(hsoapData->cTrans.szTransactionCode));
    HeartlandParseResponse("DebitMac", "TransmissionNumber", NULL_STRING, NULL_STRING, NULL_STRING, PARSE_TYPE_TRANS, response, hsoapData->cTrans.szTransmissionNumber, sizeof(hsoapData->cTrans.szTransmissionNumber));
    HeartlandParseResponse("DebitMac", "BankResponseCode", NULL_STRING, NULL_STRING, NULL_STRING, PARSE_TYPE_TRANS, response, hsoapData->cTrans.szBankResponseCode, sizeof(hsoapData->cTrans.szBankResponseCode));
    HeartlandParseResponse("DebitMac", "MacKey", NULL_STRING, NULL_STRING, NULL_STRING, PARSE_TYPE_TRANS, response, hsoapData->cTrans.szMacKey, sizeof(hsoapData->cTrans.szMacKey));
    HeartlandParseResponse("DebitMac", "PinKey", NULL_STRING, NULL_STRING, NULL_STRING, PARSE_TYPE_TRANS, response, hsoapData->cTrans.szPinKey, sizeof(hsoapData->cTrans.szPinKey));
    HeartlandParseResponse("DebitMac", "FieldKey", NULL_STRING, NULL_STRING, NULL_STRING, PARSE_TYPE_TRANS, response, hsoapData->cTrans.szFieldKey, sizeof(hsoapData->cTrans.szFieldKey));
    HeartlandParseResponse("DebitMac", "TraceNumber", NULL_STRING, NULL_STRING, NULL_STRING, PARSE_TYPE_TRANS, response, hsoapData->cTrans.szTraceNumber, sizeof(hsoapData->cTrans.szTraceNumber));
    HeartlandParseResponse("DebitMac", "MessageAuthenticationCode", NULL_STRING, NULL_STRING, NULL_STRING, PARSE_TYPE_TRANS, response, hsoapData->cTrans.szMessageAuthenticationCode, sizeof(hsoapData->cTrans.szMessageAuthenticationCode));    
